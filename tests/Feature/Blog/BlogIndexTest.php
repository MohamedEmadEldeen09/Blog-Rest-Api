...
/**
 * For Admin
 * - admin can see the channel blogs even if he is not subscribed to this channel
 */

/**
 * Index method Test Cases
 * - if the channel is the main app channel so there is no need to auth
 * - but if not make sure that this user is subscribed to that channel to see its blogs 
 * - return only the blogs that is in this channel
 * - response json -->> body - status code
 * - search and filters query parameters
 */
