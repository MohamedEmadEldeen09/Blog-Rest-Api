...
/**
 * ----------------- Test Cases -----------------
 * 1- admin can see the blog even he is not subscribed to this channel
 * 2- can see specific response body
 * 3- user can not see the blog if he is not subscribed to the channel
 * ---------------------------------------------
 */

describe('Test the blog showing process', function () {
